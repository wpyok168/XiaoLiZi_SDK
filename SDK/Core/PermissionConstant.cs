...
namespace SDK.Core
{
    public static class PermissionConstant
    {
        ...
        public static void Init()
        {
            ...
            PermiCon.Add("API[119]", "下线其他设备");//3.0框架之前需要修改为PermiCon.Add("API[119]", "下线PCQQ");
            ...
            PermiCon.Add("API[157]", "取资料展示设置");
            PermiCon.Add("API[158]", "设置资料展示");
            PermiCon.Add("API[159]", "获取当前登录设备信息");
            PermiCon.Add("API[160]", "提取图片文字");
            PermiCon.Add("API[161]", "取消精华");
            PermiCon.Add("API[162]", "群权限_设置加群方式");
            PermiCon.Add("API[163]", "群权限_群幸运字符");
            PermiCon.Add("API[164]", "群权限_一起写");
            PermiCon.Add("API[165]", "取QQ空间cookie");
            PermiCon.Add("API[166]", "修改指定QQ缓存密码");
            PermiCon.Add("API[167]", "处理群验证事件_风险号");
            PermiCon.Add("API[168]", "查询网址安全性");
            PermiCon.Add("API[169]", "消息合并转发至好友");
            PermiCon.Add("API[170]", "消息合并转发至群");
            PermiCon.Add("API[171]", "禁言群匿名");
            PermiCon.Add("API[172]", "领取私聊普通红包");
            PermiCon.Add("API[173]", "领取群聊专属红包");
            PermiCon.Add("API[174]", "发送讨论组消息");
            PermiCon.Add("API[175]", "发送讨论组json消息");
            PermiCon.Add("API[176]", "发送讨论组xml消息");
            PermiCon.Add("API[177]", "发送讨论组临时消息");
            PermiCon.Add("API[178]", "撤回消息_讨论组");
            PermiCon.Add("API[179]", "回复QQ咨询会话");
            PermiCon.Add("API[180]", "发送订阅号私聊消息");
            PermiCon.Add("API[181]", "取讨论组名称_从缓存");
            PermiCon.Add("API[182]", "修改讨论组名称");
            PermiCon.Add("API[183]", "取讨论组成员列表");
            PermiCon.Add("API[184]", "强制取自身匿名Id");
            PermiCon.Add("API[185]", "取订阅号列表");
            PermiCon.Add("API[186]", "取讨论组列表");
            PermiCon.Add("API[187]", "邀请好友加群_批量");
            PermiCon.Add("API[188]", "邀请好友加入讨论组_批量");
            PermiCon.Add("API[189]", "讨论组口令红包");
            PermiCon.Add("API[190]", "讨论组拼手气红包");
            PermiCon.Add("API[191]", "讨论组普通红包");
            PermiCon.Add("API[192]", "讨论组画图红包");
            PermiCon.Add("API[193]", "讨论组语音红包");
            PermiCon.Add("API[194]", "讨论组接龙红包");
            PermiCon.Add("API[195]", "讨论组专属红包");
            PermiCon.Add("API[196]", "领取讨论组专属红包");
            PermiCon.Add("API[197]", "取讨论组未领红包");
            PermiCon.Add("API[198]", "取讨论组文件下载地址");
            PermiCon.Add("API[199]", "发送QQ咨询会话");
            PermiCon.Add("API[200]", "创建群聊");
            PermiCon.Add("API[201]", "取群应用列表");
            PermiCon.Add("API[202]", "退出讨论组");
            PermiCon.Add("API[203]", "群验证消息接收设置");
            PermiCon.Add("API[204]", "转让群");
            PermiCon.Add("API[205]", "修改好友备注");
